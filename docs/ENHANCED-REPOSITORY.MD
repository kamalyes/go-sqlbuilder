...
enhanced := sqlbuilder.NewEnhancedRepository[Article](handler, logger, "articles")
...
enhanced := sqlbuilder.NewEnhancedRepository[Product](handler, logger, "products")
...
enhanced := sqlbuilder.NewEnhancedRepository[Comment](handler, logger, "comments")
...
enhanced := sqlbuilder.NewEnhancedRepository[Task](handler, logger, "tasks")
...
query := sqlbuilder.NewQuery().Limit(100).Offset(99900)
```

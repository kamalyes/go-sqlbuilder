...
func main() {
    ...
    // 3. 创建 Repository
    handler, _ := sqlbuilder.NewGormHandler(db)
...
// 预加载关联数据
query := sqlbuilder.NewQuery().AddPreload("Profile").AddPreload("Orders")

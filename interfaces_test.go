 ...
 * @LastEditTime: 2025-11-23 21:52:40
 * @FilePath: \go-sqlbuilder\interfaces_test.go
 * @Description:
 *
...
func TestNewEqFilter(t *testing.T) {
	...
	assert.Equal(t, OP_EQ, filter.Operator, "操作符应为 OP_EQ")
...
func TestNewGtFilter(t *testing.T) {
	...
	assert.Equal(t, OP_GT, filter.Operator, "操作符应为 OP_GT")
...
func TestNewLtFilter(t *testing.T) {
	...
	assert.Equal(t, OP_LT, filter.Operator, "操作符应为 OP_LT")
...
func TestNewGteFilter(t *testing.T) {
	...
	assert.Equal(t, OP_GTE, filter.Operator, "操作符应为 OP_GTE")
...
func TestNewLteFilter(t *testing.T) {
	...
	assert.Equal(t, OP_LTE, filter.Operator, "操作符应为 OP_LTE")
...
func TestNewInFilter(t *testing.T) {
	...
	assert.Equal(t, OP_IN, filter.Operator, "操作符应为 OP_IN")
...
func TestNewLikeFilter(t *testing.T) {
	...
	assert.Equal(t, OP_LIKE, filter.Operator, "操作符应为 OP_LIKE")
	assert.Equal(t, "%test%", filter.Value, "值应为 '%test%'")
}
...
func TestNewNeqFilter(t *testing.T) {
	...
	assert.Equal(t, OP_NEQ, filter.Operator, "操作符应为 OP_NEQ")
...
func TestNewBetweenFilter(t *testing.T) {
	...
	assert.Equal(t, OP_BETWEEN, filter.Operator, "操作符应为 OP_BETWEEN")
...
func TestNewNotInFilter(t *testing.T) {
	...
	assert.Equal(t, OP_NOT_IN, filter.Operator, "操作符应为 OP_NOT_IN")
...
func TestNewIsNullFilter(t *testing.T) {
	...
	assert.Equal(t, OP_IS_NULL, filter.Operator, "操作符应为 OP_IS_NULL")
...
func TestNewIsNotNullFilter(t *testing.T) {
	...
	assert.Equal(t, OP_IS_NOT_NULL, filter.Operator, "操作符应为 OP_IS_NOT_NULL")
	assert.Nil(t, filter.Value, "值应为 nil")
}
...
func TestNewNotLikeFilter(t *testing.T) {
	...
	assert.Equal(t, OP_NOT_LIKE, filter.Operator, "操作符应为 OP_NOT_LIKE")
...
func TestNewFindInSetFilter(t *testing.T) {
	...
	assert.Equal(t, OP_FIND_IN_SET, filter.Operator, "操作符应为 OP_FIND_IN_SET")
...
func TestNewFilterGroup(t *testing.T) {
	...
	assert.Equal(t, LOGIC_AND, andGroup.LogicOp, "逻辑操作符应为 AND")
...
func TestFilterGroupAddGroup(t *testing.T) {
	parentGroup := NewFilterGroup(LOGIC_AND)
	childGroup := NewFilterGroup(LOGIC_OR)
...
func TestFindOptions(t *testing.T) {
	options := &FindOptions{
		Conditions: []Condition{
			...
			{Field: "priority", Op: OP_GT, Value: 3},
		},
		Orders: []OrderBy{
	...
	assert.Equal(t, OP_EQ, options.Conditions[0].Op, "第一个条件操作符应为 OP_EQ")
